...
import com.example.demo.db.service.CountryService;
...
public class CountryController {
    ...
    public ModelAndView getAll(Country country){
        ...
        view.addObject("pageInfo",new PageInfo<Country>(countries));
        view.addObject("queryParam",country);
        view.addObject("page",country.getPage());
        view.addObject("rows",country.getRows());
        return view;
    }
